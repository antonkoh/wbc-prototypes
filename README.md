...
| [`wiki-profile/`](wiki-profile/) | The manager's side of the hosting policy review: describing the use case in the wiki profile, and submitting the instance for review. Two variants of the same story - [`/full`](https://wbc-hp-submissions.netlify.app/full) and [`/mvp`](https://wbc-hp-submissions.netlify.app/mvp). | [link](https://wbc-hp-submissions.netlify.app) |
